...
function activity6() {
	...
	pp.showdescription(
		'<p style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: 2.0vw;">Enter all the readings in the table columns</p>',
		3
	);
...
function act6_verify_tab1() {
	let val1: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('a6-inp1')
	);
	let val2: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('a6-inp2')
	);
	let val3: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('a6-inp3')
	);
	...
	pp.showdescription(
		'<p style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: 2.0vw;">Great!! Values are correct. Click next to load complete table</p>',
		3
	);
...
function verify_summations() {
	let val1: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('act6-tab3-inp1')
	);
	let val2: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('act6-tab3-inp2')
	);
	let val3: HTMLInputElement = <HTMLInputElement>(
		document.getElementById('act6-tab3-inp3')
	);
